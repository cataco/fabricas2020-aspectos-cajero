...
public class ComandoTransferir implements Comando {
	...
	public void ejecutar(Banco contexto) throws Exception {
		...
		if(Cajero.auditoria) {
			String datos = "TRANSFERENCIA: de "+numeroCuentaOrigen+" a "+numeroCuentaDestino+" por monto "+valor;
		...
		try {
			...
			if(Cajero.saldoReducido && cuentaOrigen.getSaldo()-valorNumerico < 200000) {
				throw new Exception ("La cuenta no puede quedar con un saldo menor a 200.000");
			}
